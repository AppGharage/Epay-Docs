    ...
    <nav class="flex items-center py-2" aria-role="navigation">
        ...
        <div class="flex items-center">
            <a href="https://github.com/tightenco/jigsaw" title="Contribute to Jigsaw on GitHub"
                ...
                <img src="/assets/img/GitHub.svg" alt="GitHub alien logo" class="-mb-1 fill-current">
            </a>

            <p class="flex items-center text-sm">
                A project by
                <a href="https://tighten.co" title="Tighten | Product Development for Web + Mobile">Tighten.co</a>
            </p>
        </div>
    </nav>
</header>

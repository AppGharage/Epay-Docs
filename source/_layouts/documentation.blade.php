    ...
    <div class="row">
        <div class="col-md-3 m-xs-b-6">
            <nav class="nav-list">
                ...
                <a class="nav-list-item" href="{{ $page->asset_prefix }}/docs/blade-templates-and-partials/">Supported File Types</a>
                <a class="nav-list-item nav-list-item--sub" href="{{ $page->asset_prefix }}/docs/blade-templates-and-partials/">Blade Templates &amp; Partials</a>
                <a class="nav-list-item nav-list-item--sub" href="{{ $page->asset_prefix }}/docs/markdown/">Markdown</a>
                <a class="nav-list-item nav-list-item--sub" href="{{ $page->asset_prefix }}/docs/other-file-types/">Other File Types</a>
